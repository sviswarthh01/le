...
#e Domain request: POST / user_key=f720fe54&load_hosts=true&request=get_user&load_logs=true {'Content-Type': 'application/x-www-form-urlencoded'}
#e Request / user_key=f720fe54&load_hosts=true&request=get_user&load_logs=true returned status 200
